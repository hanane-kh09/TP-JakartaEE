...
public class StudentController {
    ...
    @PatchMapping("/{studentId}/cours/{coursId}")
    public ResponseEntity<StudentResponseDTO> assignCours(
            @PathVariable Long studentId,
            @PathVariable Long coursId) {
        return ResponseEntity.ok(studentService.assignCours(studentId, coursId));
    }
}